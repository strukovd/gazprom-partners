		...
		<main class="page-blocks">
			...
			<BaseIsland class="rp-summary">
				...
				<div class="rp-summary-item">
					...
					<div class="rp-summary-value">25.05.2026</div>
				</div>
				<div class="rp-summary-item">
					<div class="rp-summary-label">Исполнитель</div>
					<div class="rp-summary-value"><BaseIcon name="mdi-account-outline" size="1em"/>Некрасова Наталия Михайловна</div>
				</div>
				<div class="rp-summary-item">
					<div class="rp-summary-label">Абонентов</div>
					<div class="rp-summary-value">217</div>
				</div>
			...
			<BaseIsland class="rp-filter">
				...
				<div class="rp-filter-controls">
					...
					<BaseAutocomplete v-model="model" :items="modelFilters" emitValue placeholder="Все"/>
				</div>
			</BaseIsland>
			...
			<BaseIsland class="rp-street">
				...
				<BaseTable class="rp-street-table" :columns="subscriberColumns" :rows="subscribers" rowKey="account">
